export const en = {
    ...
    'benchmark.badge': 'High Performance',
    'benchmark.description': 'Compare the rendering performance of ModernJS against other popular frameworks.',
    'benchmark.run_all': 'Run Benchmark',
    ...
    'features.pipes.date.title': 'Date & Time',
    'features.pipes.date.desc': 'Live updates using the DatePipe with various formats.',
    'features.modal.title': 'Modal Demo',
    'features.modal.system.title': 'Modal System',
    'features.modal.system.desc': 'Demonstration of the new Promise-based modal system with various types.',
    'features.modal.alert': 'Alert',
    'features.modal.confirm': 'Confirm',
    'features.modal.prompt': 'Prompt',
    'features.modal.custom': 'Custom',
    'features.modal.alert.message': 'This is a simple alert dialog.',
    'features.modal.alert.title': 'Alert',
    'features.modal.confirm.message': 'Do you want to proceed with this action?',
    'features.modal.confirm.title': 'Confirm Action',
    'features.modal.confirm.ok': 'You clicked OK!',
    'features.modal.confirm.cancel': 'You clicked Cancel.',
    'features.modal.confirm.confirmed': 'Confirmed',
    'features.modal.confirm.cancelled': 'Cancelled',
    'features.modal.prompt.message': 'Please enter your name:',
    'features.modal.prompt.default': 'Guest',
    'features.modal.prompt.title': 'Welcome',
    'features.modal.prompt.hello': 'Hello, {0}!',
