...
import * as di from '../../src/di/di.js';
import * as renderer from '../../src/component/renderer.js';
import * as template from '../../src/component/template.js';
import * as compiler from '../../src/component/compiler.js';
...
vi.mock('../../src/component/renderer.js', () => ({
    render: vi.fn()
}));

vi.mock('../../src/component/template.js', () => ({
    compileTemplate: vi.fn((tpl) => tpl)
}));

vi.mock('../../src/component/compiler.js', () => ({
